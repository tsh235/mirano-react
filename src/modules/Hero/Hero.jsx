    ...
    <div className="container">
      ...
      <figure className="hero__group-image">
        <picture className="hero__image hero__image_left">
          ...
          <img src="/img/hero-left@1x.jpg" srcSet="/img/hero-left@2x.jpg 2x" alt="Букет цветов в банке. В букете ярко-оранжевые розы, тюльпаны и львиный зев" />
        </picture>

        <svg className="hero__image hero__image_center" role="img" aria-label="Букет цветов в вазе. В букете розовые хризантемы, розы, нежно розовые орхидеи и зеленые листья папоротника" width="680" height="588"
          viewBox="0 0 680 588" fill="none"
          xmlns="http://www.w3.org/2000/svg"
          preserveAspectRatio="xMidYMid slice">
          <clipPath id="hero-center">
        ...
        <picture className="hero__image hero__image_right">
          ...
          <img src="/img/hero-right@1x.jpg" srcSet="/img/hero-right@2x.jpg 2x" alt="Букет цветов в контейнере. В букете яркие розы, белые цветы и зеденые веточки." />
        </picture>
      </figure>
    </div>
  </section>
